...
final class BloodSugarController: MiaoMiaoManagerDelegate {
    ...
    @objc func didWantToConnect() {
        os_log("didTapConnectButton called. miaoMiaoManager.state is %{public}@", log: BloodSugarController.bt_log, type: .default, String(describing: miaoMiaoManager.state))
